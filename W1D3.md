...
- Simple values are always siggned by value-copy
...
- The value of this will be determined by the function's execution context, unless teh function is bound to some other context 
